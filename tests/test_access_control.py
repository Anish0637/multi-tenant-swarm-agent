...
class TestRBAC:
    ...
    def test_rbac_admin_permissions(self):
        ...
        user = RBACUser(user_id="user1", username="admin", role=Role.ADMIN, tenant_id="default")
    ...
    def test_rbac_user_permissions(self):
        ...
        user = RBACUser(user_id="user2", username="john", role=Role.USER, tenant_id="default")
        enforcer.register_user(user)
...
class TestABAC:
    ...
    def test_abac_department_access(self):
        ...
        # Register HR subject
        hr_subject = Subject(subject_id="emp1", attributes={"department": "HR", "clearance_level": 3})
