...
async def schedule_appointment(
    ...
    logger.info(
        ...
        extra={"patient_id": patient_id, "doctor": doctor, "date": appointment_date},
    )
...
@tool
async def access_patient_records(patient_id: str, record_type: str = "all") -> Dict[str, Any]:
    """
...
async def issue_prescription(
    ...
    logger.info(
        ...
        extra={"patient_id": patient_id, "medication": medication, "dosage": dosage},
    )
...
@tool
async def generate_health_report(patient_id: str, report_type: str = "comprehensive") -> Dict[str, Any]:
    """
...
class MedicalAgentProduction(ProductionAgent):
    ...
    async def handle_patient_records(self, patient_id: str, record_type: str = "all") -> Dict[str, Any]:
        """Handle patient records access"""
        task = TaskRequest(
            tenant_id=self.tenant_id,
            task_type="patient_records",
            payload={"patient_id": patient_id, "record_type": record_type},
            user_id="system",
        )
